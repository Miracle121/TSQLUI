 ...
 *   element or its parent. Requires {@link guide/production#disabling-debug-data Debug DB} to
 *   be enabled.
 * - `isolateScope()` - retrieves an isolate {@link ng.$rootScope.Scope scope} if one is attached directly to the
 *   current element. This getter should be used only on elements that contain a directive which starts a new isolate
 *   scope. Calling `scope()` on this element always returns the original non-isolate scope.
 *   Requires {@link guide/production#disabling-debug-data Debug DB} to be enabled.
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
   ...
   * {@link guide/production#disabling-debug-data Disabling Debug DB} for more.
   *
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *      JSONified.
     *    - **data** – `{string|Object}` – DB to be sent as the request message data.
